...
Phase 4       🔄 진행 중 — Gateway. **PR을 항목마다 잘게 낸다**(5개)
             ...
             🚩 별건: 100 TPS 종결 p99가 4,673 → 5,044ms로 **SLO를 넘었다**(직접 경로도).
                사흘 새 데이터가 쌓인 것 말고 바뀐 게 없다 — 확인 필요
             5/5 Rate Limiting + fail-open/closed 결정
