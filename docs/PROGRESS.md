...
Phase 6  🔄  고동시성 대응   ← 지금 여기
             ...
             접수 커밋 −1   ✅ transfer_db 6.05 → 5.06. 용량은 그대로 60 TPS
                              → 다음: 알림의 3.93회 (커밋 전체의 39%, 종결 경로도 아니다)
...
| 다음 병목 | **알림이 커밋의 39%** — 종결 경로가 아닌데 송금당 3.93회를 쓴다 |
...
**그래서 실제 총합은 10.5가 아니라 약 11.1이었고, 지금 10.1입니다.**
...
당연한 결과입니다 — **11회 중 1회를 줄였으니 9%**이고, 그 정도는 재현 편차보다 작습니다.
...
**`notification_db`가 전체의 39%를 씁니다.** 그런데 알림은 **종결 경로가 아닙니다** —
