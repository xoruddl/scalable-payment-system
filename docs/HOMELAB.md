...
> ⚠️ **위 문단은 메모리가 15GB이던 시절에 쓴 것입니다** (2026-09-05에 31GB로 확인).
> 숫자 셋이 지금과 다릅니다 — Mongo 기본값은 약 7GB가 아니라 **약 15GB**를 노리고,
> 여유도 9GB가 아닙니다. 서비스도 다섯 개가 아니라 **여덟 개**로 늘었습니다.
> **묶는 것 자체는 그대로 두는 게 맞습니다** — 이유가 "안 그러면 스왑"에서
> **"측정을 반복해도 조건이 같아야 한다"**로 바뀔 뿐입니다.
> 상한값을 지금 여유에 맞춰 다시 잡을지는 **미정**입니다.
