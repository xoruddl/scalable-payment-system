...
/**
 * 계좌 하나의 잔액을 몇 조각으로 쓸지 바꾼다. 운영 조치지 업무 흐름이 아니다.
 *
 * 붐비는 계좌를 찾아 쪼개는 일은 사람이(또는 지표를 보는 자동화가) 판단한다.
 * 전부 쪼개면 조회할 때마다 합산만 늘어 손해이므로, 붐비는 계좌에만 쓴다.
 */
@Service
...
public class ShardingService {
	...
	/**
	 * 순서가 중요하다 — 조각 행을 먼저 만들고 그다음에 개수를 올린다.
	 *
	 * 반대로 하면 그 사이에 들어온 입금이 아직 없는 조각을 고른다.
